...
export default function loginContainer(props) {
    return(
        <div className="container">
            <Route exact path="/login" render={(props) => <LoginPage {...props} authToken={props.authToken} setAuthToken={props.setAuthToken} />} />
            <Route exact path="/login/password/recovery" component={ForgotPassword}/>
            <Route exact path="/login/password/temporary" component={TempPassword}/>
