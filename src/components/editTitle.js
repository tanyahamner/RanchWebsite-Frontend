...
export default function EditTitle(props) {
    ...
    const handleKeyDown = (event) => {
      ...
      const editTitleToast = () => {
        successfulToast(`${props.type[0].toUpperCase() + props.type.substring(1)} Title Successfully Edited!`);
      };
        ...
        <div className="edit-title">
          <SecurityWrapper restrict_roles="user">
            ...
            <div>
                ...
                <input onKeyPress={handleKeyDown} onBlur={onBlur} value={props.title_name} onFocus={onFocus} onChange={(e) => props.set_title(e.target.value)} autoFocus />
            </div>
            : 
